        ...
        <div class="bloco " id="divEndereco">
            <div class="caixa__login">
                ...
                <form action="#" method="post" id="formes">
                    <div class="coluna">
                        <div class="caixa__login-input">
                            <input type="text" name="txtcep" id="cep" data-mask="00000-000" minlength="8" maxlength="8"
                                required />
                            <label>CEP</label>
                        </div>
                        <div class="caixa__login-input">
                                    ...
                                    <div class="options">
                                        <div class="option-search-tags">
                                            <input type="text" class="search-tags"
                                                placeholder="Seleciona habilidades...">
                                        ...
                                        <div class="option" data-value="inteligência emocional">Inteligência emocional
                                        </div>
                                        ...
                                        <div class="option" data-value="relacionamento interpessoal">Relacionamento
                                            interpessoal</div>
                                        ...
                                        <div class="no-result-message" style="display: none;" data-value="0">Não
                                            encontrado</div>
                                    </div>
