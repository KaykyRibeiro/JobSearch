...
<body>
    <a href="home.php"><img class="back" src="../imagens/arrow-left-svgrepo-com.svg" alt=""></a>
    <main>
    <h2>Vaga</h2>
        <div class="lista">
            <div class="detalhe">
            ...
            <a class="btn-cadastro" href="verificarCandidatura.php?id=<?php echo $vag_id;?>" alt="">CADASTRE-SE></a>
        </div>
